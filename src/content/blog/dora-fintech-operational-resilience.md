...
1. **Map critical functions to the ICT that supports them.** You cannot protect or test what you have not identified, the first control in resilience as in compliance.
2. **Build the third-party register and fix the contracts.** Identify every ICT provider behind a critical function, and confirm the contractual rights and exit strategies DORA requires.
3. **Make incident handling real and reportable.** Classification criteria, response process, and the reporting path to your competent authority.
4. **Test, at the right level.** Vulnerability assessments and scenarios as a baseline, TLPT where you fall into scope.
5. **Put the framework in front of the board, and record it.** The accountability is theirs, and DORA expects the evidence.
